...
class RoomDetailes {
    ...
    RoomDetailes.fromJson(Map<String, dynamic> json) {
        ...
        woods = json["woods"] == null ? null : (json["woods"] as List).map((e) => Woods.fromJson(e)).toList();
        fabrics = json["fabrics"] == null ? null : (json["fabrics"] as List).map((e) => Fabrics.fromJson(e)).toList();
...
class Room {
    ...
    Room({this.id, this.name, this.categoryId, this.categoryName, this.description, this.imageUrl, this.countReserved, this.time, this.price, this.count, this.isFavorite, this.isLiked, this.likesCount, this.averageRating, this.totalRate, this.items});
